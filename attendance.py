...
message = tk.Label(window, text="IKGPTU MAIN CAMPUS" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold')) 
message.place(x=1100, y=760)

message = tk.Label(window, text="ATTENDIFY ME!" ,bg="pink"  ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
